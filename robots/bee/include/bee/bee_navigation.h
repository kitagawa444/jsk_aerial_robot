...
namespace aerial_robot_navigation
{
  ...
  class BeeNavigator : public GimbalrotorNavigator
  {
  public:
    BeeNavigator();
    ~BeeNavigator(){}
  ...
  protected:
    ...
    {
      GimbalrotorNavigator::setFinalTargetBaselinkRPY(rpy);
    ...
    {
      double r, p, y;
      tf::Matrix3x3(getFinalTargetBaselinkRot()).getRPY(r, p, y);
  ...
  template<> inline KDL::Frame BeeNavigator::getCog2CoM()
  {
