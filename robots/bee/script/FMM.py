...
class FMM():
    def __init__(self):
        ...
        #subscriber
        self.module_2_odom_sub = rospy.Subscriber("bee2/uav/cog/odom", Odometry, self.obstacleCb)
        self.module_1_odom_sub = rospy.Subscriber("bee1/uav/cog/odom", Odometry, self.agentPosCb)
        #transformations
