...
def main():
    ...
    est_wrench_sub_1 = rospy.Subscriber("/bee1/estimated_external_wrench",WrenchStamped,estWrenchCb1)
    est_wrench_sub_2 = rospy.Subscriber("/bee2/estimated_external_wrench",WrenchStamped,estWrenchCb2)
    filtered_wrench_pub_1 = rospy.Publisher("/bee1/filtered_est_wrench", WrenchStamped, queue_size = 1)
    filtered_wrench_pub_2 = rospy.Publisher("/bee2/filtered_est_wrench", WrenchStamped, queue_size = 1)
    r = rospy.Rate(40)
