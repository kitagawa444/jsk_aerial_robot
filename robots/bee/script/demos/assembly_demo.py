        ...
        with sm_top:
            ...
            with sm_sub1:
                smach.StateMachine.add('StandbyState1_2',
                                       StandbyState(robot_name = 'bee1', robot_id = 1, leader = 'bee2', leader_id = 2, attach_dir = -1),
                ...
                smach.StateMachine.add('ApproachState1_2',
                                       ApproachState(robot_name = 'bee1', robot_id = 1, leader = 'bee2', leader_id = 2, attach_dir = -1),
                                       transitions={'done':'AssemblyState1_2', 'in_process':'ApproachState1_2', 'fail':'StandbyState1_2', 'emergency':'interupted_1_2'})

                smach.StateMachine.add('AssemblyState1_2', AssemblyState(robot_name = 'bee1', robot_id = 1, leader = 'bee2', leader_id = 2, attach_dir = -1),
                                       transitions={'done':'succeeded_1_2', 'emergency':'interupted_1_2'})

            with sm_sub2:
                smach.StateMachine.add('StandbyState2_3',
                                       StandbyState(robot_name = 'bee3', robot_id = 3, leader = 'bee2', leader_id = 2, attach_dir = 1),
                ...
                smach.StateMachine.add('ApproachState2_3',
                                       ApproachState(robot_name = 'bee3', robot_id = 3, leader = 'bee2', leader_id = 2, attach_dir = 1),
                                       transitions={'done':'AssemblyState2_3', 'in_process':'ApproachState2_3', 'fail':'StandbyState2_3', 'emergency':'interupted_2_3'})

                smach.StateMachine.add('AssemblyState2_3', AssemblyState(robot_name = 'bee3', robot_id = 3, leader = 'bee2', leader_id = 2, attach_dir = 1),
