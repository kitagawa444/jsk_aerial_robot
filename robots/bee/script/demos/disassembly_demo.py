        ...
        with sm_top:
            ...
            with sm_sub1:
                smach.StateMachine.add('SwitchState1_2',
                                       SwitchState(robot_name = 'bee1', robot_id = 1, neighboring = 'bee2', neighboring_id = 2, separate_dir = -1),
                                       transitions={'done':'SeparateState1_2'})

                smach.StateMachine.add('SeparateState1_2',
                                       SeparateState(robot_name = 'bee1', robot_id = 1, neighboring = 'bee2'),
                                       transitions={'done':'succeeded_1_2','in_process':'SeparateState1_2'})

            with sm_sub2:
                smach.StateMachine.add('SwitchState2_3',
                                       SwitchState(robot_name = 'bee3', robot_id = 3, neighboring = 'bee2', neighboring_id = 2, separate_dir = 1), 
                                       transitions={'done':'SeparateState2_3'})

                smach.StateMachine.add('SeparateState2_3',
                                       SeparateState(robot_name = 'bee3', robot_id = 3, neighboring = 'bee2',separate_vel = 0.12),
