...
class AssembleDemo():
    ...
    def main(self):
        ...
        with sm_top:
            # contact
            smach.StateMachine.add('ContactState', ContactState(edge_module='bee4'), transitions={'done':'StandbyState_3_4', 'in_process':'ContactState'})

            # module3 -> module4
            smach.StateMachine.add('StandbyState_3_4', StandbyState(leader='bee4',follower='bee3'), transitions={'done':'ApproachState_3_4', 'in_process':'StandbyState_3_4'})
            smach.StateMachine.add('ApproachState_3_4', ApproachState(leader='bee4',follower='bee3'), transitions={'done':'AssemblyState_3_4', 'in_process':'ApproachState_3_4', 'fail':'StandbyState_3_4'})
            smach.StateMachine.add('AssemblyState_3_4', AssemblyState('bee4','bee3'), transitions={'done':'StandbyState_2_3'})

            # module2 -> module3
            smach.StateMachine.add('StandbyState_2_3', StandbyState(leader='bee3',follower='bee2'), transitions={'done':'ApproachState_2_3', 'in_process':'StandbyState_2_3'})
            smach.StateMachine.add('ApproachState_2_3', ApproachState(leader='bee3',follower='bee2'), transitions={'done':'AssemblyState_2_3', 'in_process':'ApproachState_2_3', 'fail':'StandbyState_2_3'})
            smach.StateMachine.add('AssemblyState_2_3', AssemblyState('bee3','bee2'), transitions={'done':'StandbyState_1_2'})

            # module1 -> module2
            smach.StateMachine.add('StandbyState_1_2', StandbyState(leader='bee2',follower='bee1'), transitions={'done':'ApproachState_1_2', 'in_process':'StandbyState_1_2'})
            smach.StateMachine.add('ApproachState_1_2', ApproachState(leader='bee2',follower='bee1'), transitions={'done':'AssemblyState_1_2', 'in_process':'ApproachState_1_2', 'fail':'StandbyState_1_2'})
            smach.StateMachine.add('AssemblyState_1_2', AssemblyState('bee2','bee1'), transitions={'done':'succeeded'})            
