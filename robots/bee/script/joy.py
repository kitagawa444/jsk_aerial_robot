...
class BeeJoy():
    def __init__(self):
        ...
        self.joy_sub = rospy.Subscriber("/bee1/joy",Joy, self.joyCb)
        self.joy_fb_sub = rospy.Subscriber("/bee1/joy/set_feedback",JoyFeedbackArray, self.joyFbCb)
