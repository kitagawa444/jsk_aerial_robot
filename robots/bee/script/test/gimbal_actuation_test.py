...
class GimbalTest():
    def __init__(self):
        ...
        self.kondo_pub = rospy.Publisher('/bee1/kondo_servo_cmd', ServoControlCmd, queue_size=1)
        self.gimbal_pub = rospy.Publisher('/bee1/gimbals_ctrl', JointState, queue_size=1)
