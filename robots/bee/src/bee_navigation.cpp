                                 ...
                                 double loop_du)
{
  ...
  assembly_target_rot_sub_ = nh_.subscribe("/assembly/final_target_baselink_rot", 1, &BeeNavigator::setAssemblyFinalTargetBaselinkRotCallback, this);
  ...
  for(int i = 0; i < max_modules_num_; i++){
    ...
    assembly_flag_subs_.insert(make_pair(module_name, nh_.subscribe( module_name + string("/assembly_flag"), 1, &BeeNavigator::assemblyFlagCallback, this)));
